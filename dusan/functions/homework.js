...
console.log("Sum result: " + sum(5, 2));
...
console.log("Substract result: " + sub(5, 2));
...
console.log("Division result: " + div(5, 2));
...
console.log("Multiplitication result: " + mul(5, 2));
...
console.log("Exponentiation result: " + exp(5, 2));
...
console.log("Combination result: " + comb(5,2));